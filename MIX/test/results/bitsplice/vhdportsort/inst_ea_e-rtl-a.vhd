...
-- $Author: wig $
-- $Id: inst_ea_e-rtl-a.vhd,v 1.1 2006/04/10 15:42:09 wig Exp $
...
begin
	...
	-- Generated Instances and Port Mappings
		...
		port map (
			...
			v_select(0) => mix_logic0, -- __I_BIT_TO_BUSPORT
			v_select(1) => mix_logic0, -- __I_BIT_TO_BUSPORT
			v_select(2) => v_select(2),	-- RequestBusinterface:RequestBus#6(VPU)VPUinterface
			v_select(3) => mix_logic0, -- __I_BIT_TO_BUSPORT
			v_select(4) => mix_logic0, -- __I_BIT_TO_BUSPORT
