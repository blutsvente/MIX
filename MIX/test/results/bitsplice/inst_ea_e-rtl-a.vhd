...
-- $Author: wig $
-- $Id: inst_ea_e-rtl-a.vhd,v 1.2 2005/10/06 11:16:06 wig Exp $
...
architecture rtl of inst_ea_e is 
	...
	component inst_eaa_e	-- 
		...
		-- Generated Port for Entity inst_eaa_e
			...
			unsplice_a1_no3	: in	std_ulogic_vector(127 downto 0);
			unsplice_a2_all128	: in	std_ulogic_vector(127 downto 0);
			unsplice_a3_up100	: in	std_ulogic_vector(100 downto 0);
			unsplice_a4_mid100	: in	std_ulogic_vector(97 downto 0);
			unsplice_a5_midp100	: in	std_ulogic_vector(99 downto 2);
			unsplice_bad_a	: in	std_ulogic_vector(1 downto 0);
			unsplice_bad_b	: in	std_ulogic_vector(3 downto 0);
...
begin
	...
	-- Generated Signal Assignments
			...
			cp_lcmd_2(6) <= p_mix_cp_lcmd_2_6_6_gi;  -- __I_I_BUS_PORT
			...
			unsplice_a1_no3(127)<= p_mix_unsplice_a1_no3_127_127_gi;
	...
	-- Generated Instances and Port Mappings
		...
		port map (
			...
			unsplice_a1_no3(1 downto 0)=> unsplice_a1_no3(1 downto 0),
			unsplice_a1_no3(127 downto 4)=> unsplice_a1_no3(125 downto 2),
			unsplice_a1_no3(2)=> unsplice_a1_no3(127),
			unsplice_a2_all128 => unsplice_a2_all128,
			unsplice_a3_up100 => unsplice_a3_up100(100 downto 0),
			unsplice_a4_mid100 => unsplice_a4_mid100(99 downto 2),
			unsplice_a5_midp100 => unsplice_a5_midp100(99 downto 2),
			unsplice_bad_a(-1 downto ) => unsplice_bad_a( downto ), -- ERROR
			unsplice_bad_b(1 downto 0) => unsplice_bad_b(1 downto 0),
			unsplice_bad_b(3 downto 2) => unsplice_bad_b(1 downto 0),
			--!wig:CHECK: unsplice_bad_b(3) => unsplice_bad_b(1), -- # conflict
			video_p_0 => video_i(0),
		...
		port map (
			...
			cp_lcmd_2(5 downto 0) => cp_lcmd_2_tolow, -- Second way to wire to zero / GuestBusLBC(memorymappedI/O)Interface
			cp_lcmd_2(6) => cp_lcmd_2(6),
