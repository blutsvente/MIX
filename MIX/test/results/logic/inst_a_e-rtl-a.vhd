...
-- $Author: wig $
-- $Id: inst_a_e-rtl-a.vhd,v 1.1 2005/07/13 08:15:38 wig Exp $
...
architecture rtl of inst_a_e is 
	...
	--
		...
		--
			...
			signal	wire_bus	: std_ulogic_vector(7 downto 0); -- __W_PORT_SIGNAL_MAP_REQ
			signal	wire_bus_s	: std_ulogic_vector(7 downto 0); -- __W_PORT_SIGNAL_MAP_REQ
			signal	wire_s	: std_ulogic; -- __W_PORT_SIGNAL_MAP_REQ
...
begin
	...
	-- Generated Signal Assignments
			wire_bus <= wire_bus_i;  -- __I_I_BUS_PORT
			wire_bus_o <= wire_bus_s;  -- __I_O_BUS_PORT
			wire_s <= wire_i;  -- __I_I_BIT_PORT
