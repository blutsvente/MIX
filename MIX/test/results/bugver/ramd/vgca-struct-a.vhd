...
-- $Author: wig $
-- $Id: vgca-struct-a.vhd,v 1.2 2005/04/14 06:53:00 wig Exp $
...
begin
	...
	-- Generated Instances and Port Mappings
		...
		i_padframe: padframe
		port map (
			mix_logic0 => mix_logic0, -- padin (X4)
			mix_logic0_bus => mix_logic0_bus, -- padin (X4)
			ramd_i => ramd_i, -- padin (X4)
			ramd_i2 => ramd_i2, -- padin (X4)
			ramd_o => mm_ramd,
