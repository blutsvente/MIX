...
-- $Author: wig $
-- $Id: a_clk-rtl-a.vhd,v 1.1 2004/04/06 10:44:17 wig Exp $
...
architecture rtl of a_clk is 
	...
	component a_fsm	-- 
		...
		-- Generated Port for Entity a_fsm
			...
			iosel_bus_disp	: out	std_ulogic_vector(3 downto 0);
	...
	--
		...
		--
			...
			signal	iosel_0	: std_ulogic(3 downto 0); 
			--  __I_OUT_OPEN signal	iosel_1	: std_ulogic; 
			--  __I_OUT_OPEN signal	iosel_2	: std_ulogic; 
			--  __I_OUT_OPEN signal	iosel_3	: std_ulogic; 
			--  __I_OUT_OPEN signal	iosel_4	: std_ulogic; 
			--  __I_OUT_OPEN signal	iosel_5	: std_ulogic; 
			--  __I_OUT_OPEN signal	iosel_6	: std_ulogic; 
			--  __I_OUT_OPEN signal	iosel_7	: std_ulogic; 
			signal	iosel_disp	: std_ulogic(3 downto 0); 
			--  __I_OUT_OPEN signal	iosel_ls_hr	: std_ulogic; 
			--  __I_OUT_OPEN signal	iosel_ls_min	: std_ulogic; 
			--  __I_OUT_OPEN signal	iosel_ms_hr	: std_ulogic; 
			--  __I_OUT_OPEN signal	iosel_ms_min	: std_ulogic; 
...
begin
	...
	-- Generated Instances and Port Mappings
		...
		port map (
			...
			iosel_bus(0) => iosel_0(0), -- IO_Select
			iosel_bus(1) => open, -- __I_BIT_TO_BUSPORT -- IO_Select -- __I_OUT_OPEN
			iosel_bus(2) => open, -- __I_BIT_TO_BUSPORT -- IO_Select -- __I_OUT_OPEN
			iosel_bus(3) => open, -- __I_BIT_TO_BUSPORT -- IO_Select -- __I_OUT_OPEN
			iosel_bus(4) => open, -- __I_BIT_TO_BUSPORT -- IO_Select -- __I_OUT_OPEN
			iosel_bus(5) => open, -- __I_BIT_TO_BUSPORT -- IO_Select -- __I_OUT_OPEN
			iosel_bus(6) => open, -- __I_BIT_TO_BUSPORT -- IO_Select -- __I_OUT_OPEN
			iosel_bus(7) => open, -- __I_BIT_TO_BUSPORT -- IO_Select -- __I_OUT_OPEN
			iosel_bus_disp => iosel_disp, -- IO_Select
			iosel_bus_ls_hr => open, -- IO_Select -- __I_OUT_OPEN
			iosel_bus_ls_min => open, -- IO_Select -- __I_OUT_OPEN
			iosel_bus_ms_hr => open, -- IO_Select -- __I_OUT_OPEN
			iosel_bus_ms_min => open, -- IO_Select -- __I_OUT_OPEN
		...
		port map (
			...
			p_mix_iosel_0_0_0_gi => iosel_0(0), -- IO_Select
