...
// $Author: wig $
// $Id: ent_a.v,v 1.1 2007/03/01 16:26:06 wig Exp $
...
// End of generated module header
	...
	`endif
		...
		`ifdef insert_emu_mux_inst_aa
			.port_aa_4(sig_04_emux_s),	// Interhierachy link, will create p_mix_sig_4_gi
		`else
	...
	`endif
		...
		`ifdef insert_emu_mux_inst_ab
			.port_ab_1(sig_01_emux_s),	// Use internally test1Will create p_mix_sig_1_go port
		`else
		...
		`ifdef insert_emu_mux_inst_ab
			.sig_13(sig_13_emux_s),	// Create internal signal name
		`else
			.sig_13(sig_13),	// Create internal signal name
		`endif
		`ifdef insert_emu_mux_inst_ab
			.sig_14(sig_14_emux_s)	// Multiline comment 1
					// Multiline comment 2
					// Multiline comment 3
		`else
			.sig_14(sig_14)	// Multiline comment 1
	...
	`define insert_emu_mux_inst_ac
		// Emulator Data Injection Path, generated by MIX
		wire emu_mux_inst_ac = 1'b0;
		wire		sig_02_emux_s;
		wire		sig_02_vc_s;

		assign sig_02_emux_s	= emu_mux_inst_ac ? sig_02_vc_s	: sig_02[3];

	`endif
		// Generated Instance Port Map for inst_ac
		ent_ac inst_ac (
		`ifdef insert_emu_mux_inst_ac
			.port_ac_2(sig_02_emux_s)	// Use internally test2, no port generated
		`else
	...
	`define insert_emu_mux_inst_ad
		// Emulator Data Injection Path, generated by MIX
		wire emu_mux_inst_ad = 1'b0;
		wire		sig_02_emux_s;
		wire		sig_02_vc_s;

		assign sig_02_emux_s	= emu_mux_inst_ad ? sig_02_vc_s	: sig_02[4];

	`endif
		// Generated Instance Port Map for inst_ad
		ent_ad inst_ad (
		`ifdef insert_emu_mux_inst_ad
			.port_ad_2(sig_02_emux_s)	// Use internally test2, no port generated
		`else
	...
	`define insert_emu_mux_inst_ae
		// Emulator Data Injection Path, generated by MIX
		wire emu_mux_inst_ae = 1'b0;
		wire	[1:0]	sig_02_emux_s;
		wire	[1:0]	sig_02_vc_s;
		wire	[4:3]	sig_02_emux_s;
		wire	[4:3]	sig_02_vc_s;
		...
		assign sig_02_emux_s	= emu_mux_inst_ae ? sig_02_vc_s	: sig_02[1:0];
		assign sig_02_emux_s	= emu_mux_inst_ae ? sig_02_vc_s	: sig_02[4:3];
		assign sig_05_emux_s	= emu_mux_inst_ae ? sig_05_vc_s	: sig_05;
		assign sig_07_emux_s	= emu_mux_inst_ae ? sig_07_vc_s	: sig_07;
		assign sig_ae_emux_s	= emu_mux_inst_ae ? sig_ae_vc_s	: sig_i_ae;

	`endif
		// Generated Instance Port Map for inst_ae
		ent_ae inst_ae (
		`ifdef insert_emu_mux_inst_ae
			.port_ae_2[1:0](sig_02_emux_s), 	// Use internally test2, no port generated// __E_CANNOT_COMBINE_SPLICES
		`else
			.port_ae_2[1:0](sig_02[1:0]), 	// Use internally test2, no port generated// __E_CANNOT_COMBINE_SPLICES
		`endif
		`ifdef insert_emu_mux_inst_ae
			.port_ae_2[4:3](sig_02_emux_s), 	// Use internally test2, no port generated// __E_CANNOT_COMBINE_SPLICES
		`else
			.port_ae_2[4:3](sig_02[4:3]), 	// Use internally test2, no port generated// __E_CANNOT_COMBINE_SPLICES
		`endif
		`ifdef insert_emu_mux_inst_ae
			.port_ae_5(sig_05_emux_s),	// Bus, single bits go to outsideBus, single bits go to outside, will create p_mix_sig_5_2_2_goBu...
		`else
		...
		`endif
			.sig_08(sig_08),	// VHDL intermediate needed (port name)
		`ifdef insert_emu_mux_inst_ae
			.sig_i_ae(sig_ae_emux_s),	// Input Bus
		`else
