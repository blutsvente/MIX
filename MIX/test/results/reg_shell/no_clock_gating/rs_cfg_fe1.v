...
// Generated
//  by:  lutscher
//  on:  Fri Oct 28 14:34:22 2005
//  cmd: /home/lutscher/work/MIX/mix_0.pl -strip -nodelta ../../reg_shell.sxc
//
// !!! Do not edit this file! Autogenerated by MIX !!!
// $Author: lutscher $
// $Id: rs_cfg_fe1.v,v 1.1 2005/10/28 12:48:35 lutscher Exp $
// $Date: 2005/10/28 12:48:35 $
// $Log: rs_cfg_fe1.v,v $
// Revision 1.1  2005/10/28 12:48:35  lutscher
// initial release
//
//
...
// End of generated module header
	...
	// Generated Signal Assignments
        ...
        */
        ...
        assign wr_p = ~rd_wr_i & u2_i_trans_start_p;

        // read txn start pulse
        assign rd_p = rd_wr_i & u2_i_trans_start_p;

        /*
          generate txn done signals
        */
        assign wr_done_p = ~rd_wr_i & u2_i_trans_start_p; // immediate ack for posted writes
        ...
        always @(posedge clk_f20 or negedge u3_i_int_rst_n) begin
        if (~u3_i_int_rst_n) begin
            int_trans_done <= 0;
            rd_delay1 <= 0;
        end
        else begin
	...
	// Generated Instances and Port Mappings
		...
		sync_generic	#(
			...
			.rstval(0),
			.sync(0)
		) u2_i (	// Synchronizer for trans_done signal

			.clk_r(clk_f20),
			.clk_s(tie0_1),
			.rcv_o(u2_i_trans_start_p),
			.rst_r(res_f20_n_i),
			.rst_s(tie0_1),
			.snd_i(trans_start)
		);
		...
		sync_rst	#(
			.act(0),
			.sync(0)
		) u3_i (	// Reset synchronizer

			.clk_r(clk_f20),
			.rst_i(res_f20_n_i),
			.rst_o(u3_i_int_rst_n)
		);
		...
		sync_generic	#(
			...
			.rstval(0),
			.sync(1)
		) u4_i (	// Synchronizer for update-signal upd_rw
		...
		sync_generic	#(
			...
			.rstval(0),
			.sync(1)
		) u5_i (	// Synchronizer for update-signal upd_r
