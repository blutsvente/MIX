...
// Generated
//  by:  lutscher
//  on:  Fri Oct 28 14:33:44 2005
//  cmd: /home/lutscher/work/MIX/mix_0.pl -strip -nodelta ../../reg_shell.sxc
//
// !!! Do not edit this file! Autogenerated by MIX !!!
// $Author: lutscher $
// $Id: rs_cfg_fe1.v,v 1.1 2005/10/28 12:47:08 lutscher Exp $
// $Date: 2005/10/28 12:47:08 $
// $Log: rs_cfg_fe1.v,v $
// Revision 1.1  2005/10/28 12:47:08  lutscher
// initial release
//
//
...
// End of generated module header
	...
	// Generated Signal Assignments
        ...
        */
        ...
        // write-clock enable
        assign wr_clk_en = wr_p;

        // shadow-clock enable
        assign shdw_clk_en = |{int_upd_w,int_upd_rw,int_upd_r};
        ...
        */
        assign fwd_decode_vec = {iaddr == `REG_04_OFFS, iaddr == `REG_0C_OFFS, iaddr == `REG_1C_OFFS};
        always @(posedge clk_f20 or negedge int_rst_n) begin
            if (~int_rst_n) begin
                fwd_txn            <= 0;
                usr_r_test_rd_p_o  <= 0;
                ...
                else if (usr_r_test_rd_p_o | usr_rw_test_rd_p_o | usr_rw_test_wr_p_o | usr_w_test_wr_p_o)
	...
	// Generated Instances and Port Mappings
		...
		sync_generic	#(
			...
			.rstval(0),
			.sync(1)
		) u4_i (	// Synchronizer for update-signal upd_w
		...
		sync_generic	#(
			...
			.rstval(0),
			.sync(1)
		) u5_i (	// Synchronizer for update-signal upd_rw
		...
		sync_generic	#(
			...
			.rstval(0),
			.sync(1)
		) u6_i (	// Synchronizer for update-signal upd_r
