...
-- $Author: wig $
-- $Id: inst_t_e-rtl-a.vhd,v 1.1 2006/04/10 15:42:11 wig Exp $
...
begin
	...
	-- Generated Instances and Port Mappings
		...
		port map (
			...
			p_mix_signal_bb_ab_gi => signal_bb_ab	-- vector test bb to ab
		);
		...
		port map (
			...
			p_mix_signal_bb_ab_go => signal_bb_ab	-- vector test bb to ab
		);
