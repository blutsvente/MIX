...
// $Author: wig $
// $Id: rs_cfg_fe1.v,v 1.1 2005/11/08 08:06:53 wig Exp $
...
// End of generated module header
	...
	// Generated Signal Assignments
        ...
        */
        ...
        assign mvstart_o     = REG_0C[4:0];
        assign mvstop_shdw   = REG_0C[10:5];
        assign sha_rw2_shdw  = REG_14;
        assign usr_rw_test_o = REG_10[14:11];
        assign wd_16_test2_o = REG_1C[7:0];
        assign wd_16_test_o  = REG_18[15:0];
        ...
        */
        assign fwd_decode_vec = {iaddr == `REG_08_OFFS, iaddr == `REG_10_OFFS};
        always @(posedge clk_f20 or negedge u5_i_int_rst_n) begin
            if (~u5_i_int_rst_n) begin
                fwd_txn            <= 0;
                usr_r_test_rd_p_o  <= 0;
        ...
        */
        ...
        always @(REG_04 or REG_0C or REG_18 or iaddr or mvstop_shdw or sha_r_test_shdw or sha_rw2_shdw or usr_r_test_i or usr_rw_test_i or ycdetect_i) begin
            mux_rd_err  <= 0;
            mux_rd_data <= 0;
            case (iaddr)
                `REG_04_OFFS : begin
        ...
        */
        ...
        (
           @(posedge clk_f20) disable iff (~u5_i_int_rst_n)
