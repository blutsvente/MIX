...
// $Author: wig $
// $Id: ent_ae.v,v 1.1 2005/10/25 13:15:36 wig Exp $
...
//
		(
		input	wire	[4:0]	port_ae_2,	// Use internally test2, no port generated
		input	wire	[3:0]	port_ae_5,	// Bus, single bits go to outside
		input	wire	[3:0]	port_ae_6,	// Conflicting definition
		input	wire	[5:0]	sig_07,	// Conflicting definition, IN false!
		input	wire	[8:2]	sig_08,	// VHDL intermediate needed (port name)
		input	wire	[6:0]	sig_i_ae,	// Input Bus
		output	wire	[7:0]	sig_o_ae	// Output Bus
		);
