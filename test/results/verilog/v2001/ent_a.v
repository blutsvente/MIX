...
// $Author: wig $
// $Id: ent_a.v,v 1.1 2005/10/25 13:15:36 wig Exp $
...
//
		(
		output	wire		p_mix_sig_01_go,
		output	wire		p_mix_sig_03_go,
		input	wire		p_mix_sig_04_gi,
		output	wire	[1:0]	p_mix_sig_05_2_1_go,
		input	wire	[3:0]	p_mix_sig_06_gi,
		input	wire	[6:0]	p_mix_sig_i_ae_gi,
		output	wire	[7:0]	p_mix_sig_o_ae_go,
		input	wire		port_i_a,	// Input Port
		output	wire		port_o_a,	// Output Port
		...
		input	wire		sig_i_a2,	// Input Port
		output	wire		sig_o_a2	// Output Port
		);
